...
(custom-theme-set-faces
 'dark3
 '(default ((t (:family "Ricty Diminished" :foundry "PfEd" :width normal :height 120 :weight normal :slant normal :underline nil :overline nil :strike-through nil :box nil :inverse-video nil :foreground "#efefef" :background "gray18" :stipple nil :inherit nil))))
 ...
 '(font-lock-builtin-face ((t (:foreground "#ff8040"))))
 ...
 '(font-lock-function-name-face ((t (:weight bold :foreground "light sky blue"))))
 ...
 '(font-lock-string-face ((t (:foreground "light goldenrod" :weight bold))))
