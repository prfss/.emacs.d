...
(custom-theme-set-faces
 ...
 '(font-lock-constant-face ((t (:weight semi-bold :box nil :inherit (font-lock-string-face)))))
 '(font-lock-doc-face ((t (:foreground "#87cefa"))))
 '(font-lock-function-name-face ((t (:foreground "LightGoldenrod1" :weight semi-bold))))
 '(font-lock-keyword-face ((t (:weight bold :foreground "chocolate3"))))
 '(font-lock-negation-char-face ((t nil)))
 '(font-lock-preprocessor-face ((t (:foreground "#eebbee"))))
 '(font-lock-regexp-grouping-backslash ((t (:inherit (bold)))))
 '(font-lock-regexp-grouping-construct ((t (:inherit (bold)))))
 '(font-lock-string-face ((t (:foreground "#9acd5d"))))
 '(font-lock-type-face ((t (:weight bold :foreground "#4971c1"))))
 '(font-lock-variable-name-face ((t (:weight normal :inherit (font-lock-function-name-face)))))
 ...
 '(haskell-operator-face ((t (:inherit font-lock-doc-face))))
 '(default ((t (:background "#242020" :foreground "#dfefef"))))
 '(show-paren-match ((t (:background "OliveDrab2" :foreground "#2211ff")))))
